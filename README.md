...
settings.py after myapp creation.

### Step 2:
Create a file named 'design.html' and write down the cover page code required.

### Step 3:
Runserver to get the output.

### Step 4:
Push and commit files to the GitHub repository.
